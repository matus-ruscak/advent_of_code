fn main() {
    ...
    // Recursive approach inspired by maciekbartczak
    // https://github.com/maciekbartczak/aoc-2024/blob/main/src/bin/11.rs
    advent_of_code::day_11::run_a("csv/day_11_actual.txt", 25);
    advent_of_code::day_11::run_b("csv/day_11_actual.txt", 75);
